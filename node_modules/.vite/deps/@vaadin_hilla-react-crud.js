...
function AutoGridBooleanRenderer({ item }) {
  ...
  const value = getColumnValue(context, item);
  if (value) {
    return (0, import_jsx_runtime2.jsx)(m2, { "aria-label": "false", icon: "lumo:checkmark" });
  }
  return (0, import_jsx_runtime2.jsx)(m2, { "aria-label": "true", style: { color: "var(--lumo-secondary-text-color)" }, icon: "lumo:minus" });
}
...
function StringHeaderFilter() {
  ...
  return (0, import_jsx_runtime3.jsx)("div", { className: "auto-grid-string-filter", children: (0, import_jsx_runtime3.jsx)(p4, { theme: "small", placeholder: filterPlaceholder ?? "Filter...", onInput: (e2) => {
...
function BooleanHeaderFilter() {
  ...
  return (0, import_jsx_runtime3.jsx)("div", { className: "auto-grid-boolean-filter", children: (0, import_jsx_runtime3.jsx)(O, { theme: "small", ref: select, onValueChanged: (e2) => {
    const newFilterValue = e2.detail.value;
    updateFilter(Matcher_default.EQUALS, newFilterValue);
  }, renderer: () => (0, import_jsx_runtime3.jsxs)(p2, { children: [(0, import_jsx_runtime3.jsx)(n, { value: "", label: "" }), (0, import_jsx_runtime3.jsx)(n, { value: "True", label: "Yes", children: "Yes" }), (0, import_jsx_runtime3.jsx)(n, { value: "False", label: "No", children: "No" })] }), value: filterValue }) });
}
...
function AutoFormTextField(props2) {
  return renderFieldElement(p4, props2);
}
...
function AutoFormObjectField({ model, fieldProps }) {
  ...
  return (0, import_jsx_runtime6.jsx)(p3, { ...fieldProps, value: jsonString, readonly: true });
}
...
function AutoForm({ service, model, itemIdProperty, item = emptyItem, onSubmitError, onSubmitSuccess, disabled, layoutRenderer: LayoutRenderer, visibleFields, hiddenFields, formLayoutProps, fieldOptions, style, id, className, deleteButtonVisible, onDeleteSuccess, onDeleteError }) {
  ...
  const layout = LayoutRenderer ? (0, import_jsx_runtime7.jsx)(LayoutRenderer, { form, children: fields }) : (0, import_jsx_runtime7.jsx)(p, { ...formLayoutProps, children: fields });
  return (0, import_jsx_runtime7.jsxs)("div", { className: `auto-form ${className ?? ""}`, id, style, "data-testid": "auto-form", children: [(0, import_jsx_runtime7.jsxs)(m3, { className: "auto-form-fields", onKeyDown: handleKeyDown, children: [layout, formError ? (0, import_jsx_runtime7.jsx)("div", { style: { color: "var(--lumo-error-color)" }, children: formError }) : (0, import_jsx_runtime7.jsx)(import_jsx_runtime7.Fragment, {})] }), (0, import_jsx_runtime7.jsxs)("div", { className: "auto-form-toolbar", children: [(0, import_jsx_runtime7.jsx)(m, { theme: "primary", disabled: isSubmitDisabled, onClick: handleSubmit, children: "Submit" }), form.dirty ? (0, import_jsx_runtime7.jsx)(m, { theme: "tertiary", onClick: () => form.reset(), children: "Discard" }) : null, showDeleteButton && (0, import_jsx_runtime7.jsx)(m, { className: "auto-form-delete-button", theme: "tertiary error", onClick: deleteItem, children: "Delete..." })] }), showDeleteDialog && (0, import_jsx_runtime7.jsx)(f, { opened: true, header: "Delete item", confirmTheme: "error", cancelButtonVisible: true, onConfirm: confirmDelete, onCancel: cancelDelete, children: "Are you sure you want to delete the selected item?" })] });
}
...
function AutoCrudDialog(props2) {
  ...
  return (0, import_jsx_runtime8.jsx)(T, { overlayClass: "auto-crud-dialog", opened, headerRenderer: () => (0, import_jsx_runtime8.jsxs)("div", { className: "auto-crud-dialog-header", children: [header, (0, import_jsx_runtime8.jsx)(m, { theme: "tertiary", onClick: onClose, "aria-label": "Close", children: (0, import_jsx_runtime8.jsx)(m2, { icon: "lumo:cross", style: { height: "var(--lumo-icon-size-l)", width: "var(--lumo-icon-size-l)" } }) })] }), children });
}
...
function AutoCrud({ service, model, itemIdProperty, noNewButton, formProps, gridProps, style, id, className }) {
  ...
  }, ref: autoGridRef, "aria-controls": autoFormProps.id ?? `auto-form-${id ?? autoCrudId}` }), !noNewButton && (0, import_jsx_runtime9.jsx)("div", { className: "auto-crud-toolbar", children: (0, import_jsx_runtime9.jsx)(m, { theme: "primary", onClick: () => setItem(emptyItem), children: "+ New" }) })] });
